                ...
                <div class="seller_review_contents">
                            ...
                            <div class="seller_review_contents_search_box">
                                ...
                                <div class="seller_review_contents_search_items">
                                    ...
                                    <div class="seller_review_contents_search_item2">
                                        ...
                                        <label for="new"><span>신규 리뷰</span></label>
                                        <input type="checkbox" id="delete" class="restCheckBox" name="status" value="3">
                                        <label for="delete"><span>삭제된 리뷰</span></label>
                                    </div>
                                </div>
                                <div class="seller_review_contents_search_items">
                    ...
                    <div class="seller_review_contents_list">
                        ...
                        <table class="seller_review_contents_table">
                            ...
                            <tr>
                                <td><span>(1)</span></td>
                                <td class="seller_review_contents_table_edit_btn"><a href=""><span>수정</span></a></td>
                                <td><span>(0000.00.00)</span></td>
                                <td class="seller_review_contents_table_product_name"><span>(리뷰명입니다. 여기는 리뷰명 자리입니다. 리뷰이름이 들어갈 자리입니다. 리뷰입니다.)</span></td>
                     ...
                     <!-- 페이징 기능 -->
                     <div class="seller_review_contents_table_pasing"><a href="">1</a><a href="">2</a><a
