...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/seller/user/sellerJoin.css">

<script src="${pageContext.request.contextPath}/resources/js/jquery-3.7.1.min.js"></script>
<script src="${pageContext.request.contextPath}/resources/js/seller/user/sellerjoinService.js"></script>
<script src="${pageContext.request.contextPath}/resources/js/publicRegex/telRegex.js"></script>
<script src="${pageContext.request.contextPath}/resources/js/publicRegex/taxidRegex.js"></script>
...
<script src="${pageContext.request.contextPath}/resources/js/seller/user/sellercheckjoin.js"></script>
			...
			<div class="m_sellerJoin_title">
				<div class="m_sellerJoin_tiregion">
					...
					<div class="m_sellerJoin_tiregionre">
						<a href="${pageContext.request.contextPath}/seller/sellerLogin.do" class="m_sellerJoin_tiregionss">로그인</a>
						<a href="${pageContext.request.contextPath}/seller/sellerJoin.do" class="m_sellerJoin_tiregionss">ENT Root ID 생성</a>
					</div>
				</div>
			</div>
			<!-- #endregion -->
				...
				<form>
					...
					<div id="joinPage1" class="m_sellerJoin_page1">
						...
						<div class="m_sellerJoin_content">항상 사용할 수 있는 전화번호를 입력하십시오.
							새 기기나 웹 브라우저에 로그인할 때 해당 전화번호를 사용하여 신원을 확인합니다.
							메시지 또는 데이터 요금이 적용될 수 있습니다.</div>
