...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/seller/user/sellerLogin.css">
	...
	<div class="wrap">
		...
		<section>
			...
			<div class="m_sellerLogin_title">
				<div class="m_sellerLogin_tiregion">
					...
					<div class="m_sellerLogin_tiregionre">
						<a href="#" class="m_sellerLogin_tiregionss">로그인</a> <a href="#"
							class="m_sellerLogin_tiregionss">ENT Root ID 생성</a>
					</div>
				</div>
			</div>
			<!-- #endregion -->
			...
			<div class="m_sellerLogin_mainlogoregion">
				<div class="m_sellerLogin_main_log">
					...
					<svg xmlns="http://www.w3.org/2000/svg" width="300" height="300"
						viewBox="0 0 300 300" fill="none" id="mainLog">
                    <path fill-rule="evenodd" clip-rule="evenodd"
							d="M150 300C232.843 300 300 232.843 300 150C300 119.164 290.695 90.5015 274.741 66.6665H166.667L133.333 266.667L83.3333 183.333L14.3054 214.012C38.3235 264.837 90.0554 300 150 300ZM11.9271 208.715C4.24872 190.682 0 170.837 0 150C0 67.1573 67.1573 0 150 0C194.425 0 234.339 19.3125 261.805 49.9999H150L125 216.667L100 150L11.9271 208.715Z"
							fill="#111111" />
                </svg>
					<!-- #endregion -->
				</div>
			...
			<div id="joinPage1" class="m_sellerLogin_main">
				...
				<div class="m_sellerLogin_main_subtitle">ENT Root의 모든 서비스에
					사용하는 계정입니다.</div>
			...
			<div id="joinPage2" class="m_sellerLogin_2page">
					...
					<form>
						<div class="m_sellerLogin_buyerEmailRegion">
							<div class="m_sellerLogin_emailRegion" id="emailRegion">
								<label> <input type="email" name="email"
									class="m_sellerLogin_emailInput" id="emailInput">
						...
						<div class="m_sellerLogin_pwRegion" id="pwRegion">
							<label> <input type="password" name="pw"
								class="m_sellerLogin_pwInput" id="pwInput">
								<div class="m_sellerLogin_pwTitle" id="pwTitle">암호</div>
							</label> <label>
								<div class="arrow_small" id="pwArrowSmall"></div> <input
								type="submit" class="m_sellerLogin_submit" id="loginSubmit"
								disabled="disabled">
							</label>
						</div>
				...
				<div class="m_sellerLogin_2seletatag">
					<a href="../entUserService/entUserLogin.html"
						class="m_sellerLogin_2entuser">일반 회원입니다.</a> <a href="#"
						class="m_sellerLogin_2pwblive">암호를 잊으셨나요?</a>
				</div>
			</div>
	</div>
	<!-- #endregion -->
